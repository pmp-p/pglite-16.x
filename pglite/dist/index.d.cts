import { F as Filesystem, P as PostgresMod, a as FilesystemBase, b as FS } from './types-HPOFDDtX.cjs';
import { P as PGliteInterface, D as DebugLevel, a as PGliteOptions, b as PGliteInterfaceExtensions, Q as QueryOptions, R as Results, T as Transaction, E as ExecProtocolOptions, B as BackendMessage$1, c as ParserOptions, d as Buffer } from './interface-BjKXqrl5.cjs';
export { j as DumpDataDirResult, h as Extension, g as ExtensionSetup, f as ExtensionSetupResult, i as Extensions, F as FilesystemType, k as Row, e as RowMode, m as messages } from './interface-BjKXqrl5.cjs';
...
declare class PGlite implements PGliteInterface, AsyncDisposable {
     ...
     * @returns The result of the query
     */
    execProtocol(message: Uint8Array, { syncToFs, onNotice }?: ExecProtocolOptions): Promise<Array<[BackendMessage$1, Uint8Array]>>;
    /**
...
declare const types: {
    ...
    bytea: {
        to: number;
        from: number[];
        js: (BufferConstructor | Uint8ArrayConstructor)[];
...
declare class IdbFs extends FilesystemBase {
    ...
    syncToFs(fs: FS, _relaxedDurability?: boolean): Promise<void>;
    dumpTar(mod: FS, dbname: string): Promise<Blob | File>;
    close(FS: FS): Promise<void>;
}
...
export { DebugLevel, ExecProtocolOptions, IdbFs, MemoryFS, Mutex, PGlite, PGliteInterface, PGliteInterfaceExtensions, PGliteOptions, ParserOptions, QueryOptions, Results, Transaction, formatQuery, parse$1 as parse, index as protocol, types$1 as types, uuid };
